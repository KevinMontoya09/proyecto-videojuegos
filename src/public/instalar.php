...
// Habilitamos el reporte de errores para ver qué pasa exactamente
...
if (file_exists($ruta_final)) {
    ...
    // TRUCO: Ejecutamos el script y capturamos si hay error sin romper la página
    if ($conn->multi_query($script)) {
        // Consumir todos los resultados (necesario para multi_query)
        ...
        echo "<h2 style='color:orange'>⚠️ Nota:</h2>";
